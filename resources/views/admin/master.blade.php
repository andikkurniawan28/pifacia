        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#akses"
                    aria-expanded="true" aria-controls="akses">
                    <i class="fas fa-fw fa-key"></i>
                    <span>{{ ucfirst("akses") }}</span>
                </a>
                <div id="akses" class="collapse" aria-labelledby="akses" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="{{ route("role.index") }}">{{ ucfirst("role") }}</a>
                        <a class="collapse-item" href="{{ route("user.index") }}">{{ ucfirst("user") }}</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#master"
                    ...
                    <span>{{ ucfirst("master") }}</span>
                </a>
                <div id="master" class="collapse" aria-labelledby="master" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="{{ route("kategori_produk.index") }}">{{ ucfirst("Kategori Produk") }}</a>
                        <a class="collapse-item" href="{{ route("supplier.index") }}">{{ ucfirst("supplier") }}</a>
                        <a class="collapse-item" href="{{ route("produk.index") }}">{{ ucfirst("produk") }}</a>
                    </div>
                </div>
            </li>
